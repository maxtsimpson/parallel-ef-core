...
{
    public class DoctorsNorthContext : DbContext
    {
        ...
        public DoctorsNorthContext() : base()
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Doctor>().HasData(
                ...
                new Doctor
                {
                    ...
                    DoctorEmail = "mikeallen@example.com",
                    DoctorProfStatus = "Active",
                    DoctorStartDate = new DateTime(2005, 3, 3),
                    DoctorEndDate = new DateTime(2035, 3, 3),
                    DoctorNrn = "NRN234"
                }
            );
        }
